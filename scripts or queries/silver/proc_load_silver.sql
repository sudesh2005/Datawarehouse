...
BEGIN
    ...
    BEGIN
        ...
        SELECT '==========================================' AS Log_Header,
               'ERROR OCCURRED DURING LOADING SILVER LAYER' AS Log_Message,
               error_message AS Error_Details;
    END;

    -- 3. Execution Logic
    SET batch_start_time = NOW();
    SELECT '================================================' AS Log_Header, 'Loading Silver Layer' AS Log_Message;

    SELECT '------------------------------------------------' AS Log_Section, 'Loading CRM Tables' AS Log_Message;
    ...
    SELECT '------------------------------------------------' AS Log_Section, 'Loading ERP Tables' AS Log_Message;
    ...
    SELECT '==========================================' AS Status,
           'Loading Silver Layer is Completed' AS Message,
           CONCAT('Total Load Duration: ', TIMESTAMPDIFF(SECOND, batch_start_time, batch_end_time), ' seconds') AS Duration;
